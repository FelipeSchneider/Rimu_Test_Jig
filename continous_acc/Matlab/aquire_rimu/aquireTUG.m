...
time_sample = 40;       %número de segundos a se coletar
...
if(WAIT_SYNC == 0)
    ACTION = 192;       %ação: ler apenas o LSM+LIS
else
   ACTION = 193;        %ação: ler apenas o LSM+LIS esperando o sincronismo
end
...
title('Aceleração Linear');ylabel('X');
